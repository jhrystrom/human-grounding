...
_Generated 2026-07-13 12:52 by `scripts/report_canonical_values.py`._
...
- Responsible AI: 26.3pp
- Welfare: 19.4pp
- Government AI: 15.5pp
...
- Headline human-model gap range: 15.5-26.3pp.
...
| --- | --- | --- | --- | --- |
| Responsible AI | 0.638 | [0.632, 0.642] | 0.020 [0.016, 0.024] | between $\tau \approx 3.57$; within $\tau \approx 6.75$ |
| Welfare | 0.670 | [0.664, 0.674] | 0.026 [0.019, 0.035] | between $\tau \approx 3.01$; within $\tau \approx 4.23$ |
| Government AI | 0.491 | [0.479, 0.498] | n/a | between $\tau \approx 6.20$; within $\tau \approx 2.44$ |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Responsible AI | 0.638 | 0.504 | 0.375 | [0.369, 0.382] | multilingual-e5-large-instruct | 26.3pp | 12.9pp | -13.4pp |
| Welfare | 0.670 | 0.609 | 0.476 | [0.442, 0.492] | paraphrase-multilingual-mpnet | 19.4pp | 13.3pp | -6.1pp |
| Government AI | 0.491 | 0.627 | 0.336 | [0.309, 0.373] | mmBERTscandi-base-embedding | 15.5pp | 29.2pp | +13.6pp |
...
| --- | --- | --- | --- | --- | --- |
| Responsible AI | 0.638 | 0.504 | 0.375 | 0.403 | 0.347 |
| Welfare | 0.670 | 0.609 | 0.476 | n/a | n/a |
| Government AI | 0.491 | 0.627 | 0.336 | 0.336 | 0.336 |
...
- Adjusted $\Delta_{\mathrm{adj}}$ (length + lexical controls) = 0.011 [0.007,0.016], p <0.001.
...
- Adjusted $\Delta_{\mathrm{adj}}$ (length + lexical controls) = 0.033 [0.021,0.045], p <0.001.
...
- Human-model gap range: 15.5-26.3pp.
...
- Responsible AI: raw $\Delta_{\mathrm{group}}$ = 0.028 [0.026,0.029] (p <0.001); adjusted $\Delta_{\mathrm{adj}}$ = 0.011 [0.007,0.016] (p <0.001).
- Welfare: raw $\Delta_{\mathrm{group}}$ = 0.068 [0.062,0.073] (p <0.001); adjusted $\Delta_{\mathrm{adj}}$ = 0.033 [0.021,0.045] (p <0.001).
...
| --- | --- | --- | --- | --- | --- |
| Responsible AI | 0.504 | 0.638 | 0.375 | 12.9pp | -13.4pp |
| Welfare | 0.609 | 0.670 | 0.476 | 13.3pp | -6.1pp |
| Government AI | 0.627 | 0.491 | 0.336 | 29.2pp | +13.6pp |
...
| --- | --- | --- | --- | --- | --- |
| Responsible AI | 0.638 | 0.504 | 0.375 | 26.3pp | 12.9pp |
| Welfare | 0.670 | 0.609 | 0.476 | 19.4pp | 13.3pp |
| Government AI | 0.491 | 0.627 | 0.336 | 15.5pp | 29.2pp |
...
- Responsible AI group disparity: raw 0.028 [0.026,0.029], adjusted 0.011 [0.007,0.016].
- Welfare group disparity: raw 0.068 [0.062,0.073], adjusted 0.033 [0.021,0.045].
